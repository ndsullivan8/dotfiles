...
BUNDLE_DIR = path.join(SOURCE_DIR, 'bundle')
PATHOGEN_DIR = path.join(SOURCE_DIR, 'autoload')

def download_extract_replace(plugin_name, zip_path, temp_dir, bundle_dir):
